...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between gap-4">
        <span
          className="bg-[#CCF0F3] text-[#246BCE] py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px]
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <span className="text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-[#696969]">
            ({totalRating})
          </span>
        </div>
      </div>
