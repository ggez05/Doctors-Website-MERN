...
import doctorImg from "../../assets/images/doctor-2.jpg";
        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                <span
                  className="bg-[#CCF0F3] text-[#246BCE] py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4
              lg:text-[16px] lg:leading-7 font-semibold rounded"
                ...
                <p className="text__para text-[12px] leading-6 md:text-[13px] lg:max-w-[390px]">
                  ...
                  Explicabo quos nemo doloremque placeat. Id aliquam nobis quis
                  expedita,
                </p>
              </div>
            </div>
