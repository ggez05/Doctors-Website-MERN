...
const DoctorAbout = () => {
  return (
    <div>
      <div>
        <h3 className="text-[20px] leading-[30px] text-black font-semibold fles items-center gap-2">
          About of
        ...
        <p className="text__para">
          ...
          consectetur alias. Consequuntur voluptatum recusandae sit, hic animi
          maiores alias! Aliquid, sed rem quo explicabo autem quis eligendi
          magnam vero adipisci?
        </p>
      </div>
